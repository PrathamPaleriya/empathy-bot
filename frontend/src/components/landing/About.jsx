    ...
    <section id="about" className="py-20 px-6 md:px-12 lg:px-24">
      <div className="container mx-auto max-w-3xl text-center">
        ...
        <p className="text-lg text-[#4f4f4f] mb-8">
          Built by a solo developer who wanted to create something that truly listens. EmpathyBot
        ...
        <div className="bg-white rounded-2xl p-8 shadow-sm">
          <p className="text-[#343434] italic mb-6">
            "I created EmpathyBot because I believe emotional connection shouldn't be a luxury. In
            our busy world, we all need a safe space to express ourselves without fear of judgment."
          </p>
          <p className="font-['Manrope'] font-bold text-[#1c1c1c]">— Pratham</p>
        </div>
      </div>
    </section>
  );
