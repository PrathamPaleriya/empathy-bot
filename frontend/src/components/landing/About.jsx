    ...
    <section id="about" className="py-20 px-6 md:px-12 lg:px-24">
      <div className="container mx-auto max-w-3xl text-center">
        ...
        <p className="text-lg text-[#4f4f4f] mb-8">
          Built by a guys who wanted to create something that truly listens. EmpathyBot
        ...
        <div className="bg-white rounded-2xl p-8 shadow-sm">
          <p className="text-[#343434] italic mb-6">
            "We created EmpathyBot because we believe emotional connection shouldn't be a luxury. In
