...
const PrivacyPolicy = () => {
  return (
    <div className="bg-bg">
      <div className="pt-10">
        <Link to="/" className="px-3 md:px-10 hover:text-accent">
          Back to home
        </Link>
      </div>
        ...
        <PaddingMarging>
          <div className=" text-black font-manrope p-6 text-xs md:text-base">
            ...
            <section className="mb-8">
              ...
              <p>
                We use encrypted storage and secure systems to keep your data safe. No system is
                100% secure, but we do our best to protect your info.
              </p>
            </section>
            ...
            <section className="mb-8">
              ...
              <p>
                We operate from India. If you're outside India, you’re responsible for following
                your country’s data privacy laws.
              </p>
            </section>
            ...
            <section className="mb-8">
              ...
              <p>
                The product is currently free. We may add a subscription later and will inform you
                if we do.
              </p>
            </section>
